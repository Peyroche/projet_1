# Projet 1 : Gestion du parc informatique MDF (Sales and Marketing) 

## Contexte
Dans le cadre d'un projet fictif, une gestion du parc informatique a été réalisé pour la société MDF (Sales and Marketing). MDF est une société spécialisée dans l’externalisation commerciale et marketing, fondée en 2005 et basée à Asnières-sur-Seine (Île-de-France). Elle accompagne les grandes marques et les PME dans le développement de leur présence sur le marché, en proposant des solutions terrain et digitales adaptées aux besoins de chaque client.  
