...
|-------------|------------------|----------------|---------------------|--------------|-----------------|----------------------------------|
| Microsoft   | Windows Server   | 2019 Datacenter| Licence volume      | 5            | ✅ Conforme     | Utilisé sur serveur HP           |
| Canonical   | Ubuntu Server    | 22.04 LTS      | Open source GPL     | N/A          | ✅ Conforme     | Utilisé sur serveur Dell         |
